    ...
    <div className="flex items-center justify-center p-4">
      <Modal>
        <ModalTrigger className="bg-transparent flex justify-center group/modal-btn">
          <div className="relative w-[300px] h-[200px] rounded-lg overflow-hidden bg-gray-100 dark:bg-gray-800">
            <Image
              className="hover:scale-[1.05] transition-all duration-300 object-contain"
              src={project.src}
              alt={project.title}
              fill
              sizes="300px"
            ...
            <div className="absolute w-full h-1/2 bottom-0 left-0 bg-gradient-to-t from-black via-black/85 to-transparent pointer-events-none">
              <div className="flex flex-col h-full items-start justify-end p-6">
                <div className="text-xs bg-white text-black rounded-md w-fit px-2 py-0.5">
                  {project.category}
                </div>
              </div>
            </div>
