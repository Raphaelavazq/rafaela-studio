...
using use = useUsing("use")`,
  ...
  [SkillNames.VITE]: {
    ...
    name: "vite",
    label: "Vite",
    shortDescription: "Lightning-fast build tool for modern development",
    color: "#646cff",
  ...
  [SkillNames.FIGMA]: {
    ...
    name: "figma",
    label: "Figma",
    shortDescription: "My design home - where all projects start their journey",
    color: "#f24e1e",
  ...
  [SkillNames.ADOBEXD]: {
    ...
    name: "adobexd",
    label: "Adobe XD",
    shortDescription: "Rapid prototyping and interactive design workflows",
    color: "#ff61f6",
  ...
  [SkillNames.PHOTOSHOP]: {
    ...
    name: "photoshop",
    label: "Photoshop",
    shortDescription: "Pixel-perfect visuals and photo manipulation magic",
    color: "#31a8ff",
  ...
  [SkillNames.AFTEREFFECTS]: {
    ...
    name: "aftereffects",
    label: "After Effects",
    shortDescription: "Motion design that brings interfaces to life",
    color: "#9999ff",
  ...
  [SkillNames.FRAMERMOTION]: {
    ...
    name: "framermotion",
    label: "Framer Motion",
    shortDescription: "Smooth, production-ready animations for React apps",
    color: "#ff0055",
  ...
  [SkillNames.GSAP]: {
    ...
    name: "gsap",
    label: "GSAP",
    shortDescription: "Professional-grade JavaScript animation library",
    color: "#88ce02",
  ...
  [SkillNames.NODEJS]: {
    ...
    name: "nodejs",
    label: "Node.js",
    shortDescription: "JavaScript on the backend - full-stack made simple",
    color: "#6cc24a",
  ...
  [SkillNames.FIREBASE]: {
    ...
    name: "firebase",
    label: "Firebase",
    shortDescription: "Google's toolkit for real-time applications and hosting",
    color: "#ffca28",
  ...
  [SkillNames.GIT]: {
    ...
    name: "git",
    label: "Git",
    shortDescription: "Version control so I can experiment without breaking things",
    color: "#f1502f",
  ...
  [SkillNames.GITHUB]: {
    ...
    name: "github",
    label: "GitHub",
    shortDescription: "Where all my code lives and collaboration happens",
    color: "#181717",
  ...
  [SkillNames.VERCEL]: {
    ...
    name: "vercel",
    label: "Vercel",
    shortDescription: "One-click deployments that make launches stress-free",
    color: "#000000",
  ...
  [SkillNames.NPM]: {
    ...
    name: "npm",
    label: "NPM",
    shortDescription: "Package manager for the entire JavaScript ecosystem",
    color: "#cb3837",
