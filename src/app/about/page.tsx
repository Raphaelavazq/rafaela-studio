...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "connectwithrafaela@gmail.com",
    href: "mailto:connectwithrafaela@gmail.com",
    icon: <FaEnvelope height={"50px"} />,
  },
  {
    name: "LinkedIn",
    href: "https://linkedin.com/in/rafaelavazquaresma",
    content: "/rafaelavazquaresma",
    icon: <FaLinkedin height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/Raphaelavazq",
    content: "/Raphaelavazq",
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">Rafaela</p>
